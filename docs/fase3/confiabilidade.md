...
1. Na estrutura do *fork*, criar a pasta `tests/mocks/` contendo `/validos/` (dados reais) e `/corrompidos/` (arquivos JSON com sintaxe malformada ou valores nulos).
...
* **Ambiente de Hospedagem:** Servidor de Domínio Próprio (https://muralunb.com.br/).
